...
const OPTIONS = [
  {
    ...
    label: 'Immediately',
    description: 'Start as soon as a qualified candidate is found',
    icon: Zap,
  },
  {
    value: 'within-one-week' as const,
    label: 'Within One Week',
    description: 'Flexible start within the next 7 days',
    icon: Clock,
  },
  {
    value: 'flexible' as const,
    label: 'Flexible Start Date',
    description: 'Open to scheduling based on candidate availability',
    icon: Calendar,
  },
];
      ...
      <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 pt-8">
        <div className="text-center mb-10">
          ...
          <p className="text-base font-light text-gray-600">
            Select the preferred start date for your new team member.
          </p>
        </div>
