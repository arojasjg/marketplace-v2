export interface City {
  ...
  displayNumber: number; // Number shown during posting
}

export const CITIES: City[] = [
  // Mexico (2) - Shifted left for better alignment
  ...
  // Central America (5) - Shifted left for better alignment
  ...
  // South America (7) - Shifted left for better alignment
